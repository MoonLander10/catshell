...
std::cout << name << ">> ";
std::cin >> command;
if (command == "info" || command == "help" || command == "kalcul" || command == "clear" || command == "exit" || command == "cat#0" || command == "rand" || command == "randmax" || command == "h" || command == "numb" || command == "hot" || command == "cube" || command == "99" || command == "rm" || command == "mkdir" || command == "cd" || command == "ls" || command == "whoami") { //страшилка
if (command == "info") {
info();
}
if (command == "help") {
